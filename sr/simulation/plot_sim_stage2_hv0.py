...
filenames_in=[r"C:\Users\chwidmer\Documents\results\synthetic\seed2_complete.pickle", r"C:\Users\chwidmer\Documents\results\synthetic\seed3_complete.pickle", r"C:\Users\chwidmer\Documents\results\synthetic\seed9_complete.pickle"] 
#, r"C:\Users\chwidmer\Documents\results\synthetic\seed9_fixed_delta.pickle", r"C:\Users\chwidmer\Documents\results\synthetic\seed2_fix.pickle"]
...
def PlotForOneMethodsList():
    ...
    if 1:#new all plot
        ...
        k = np.bitwise_and(k, i_varh==3)
        k = np.bitwise_and(k, i_sib==0)
        #k = np.bitwise_and(k, i_ncausal==2)
        #import pdb; pdb.set_trace()
        num_set = sum(k)
        try:
            tmp_name = "no_fs_var_hidden=0.9_num%i" % num_set
